<script lang="ts">
	...
	const getNext = (page: number) => {
		...
		return client.query(QUERY, { page: page }).then(res => res.data.Exercises.docs);
	}
...
<div class="container">
	<div class="header-container">
		<h1>Задачи за подготовка</h1>
		<div class="line"></div>
	</div>
	<DocumentViewer documents="{data.Exercises.docs}"
					header="Задачи"
